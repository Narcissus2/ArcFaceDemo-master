...
public class DetecterActivity extends Activity implements OnCameraListener, View.OnTouchListener, Camera.AutoFocusCallback {
				...
				if (max > 0.6f) {
					...
					mHandler.post(new Runnable() {
						...
						public void run() {
							...
							if(Objects.equals(mNameShow.substring(0, 7), "visitor")) {
								mTextView.setText("visitor");
							}
							mTextView.setTextColor(Color.RED);
							mTextView1.setVisibility(View.VISIBLE);
							mTextView1.setText("置信度：" + (float)((int)(max_score * 1000)) / 1000.0);
							if((float)((int)(max_score * 1000)) / 1000.0>0.65)
							{
								Toast.makeText(DetecterActivity.this, "开锁", Toast.LENGTH_SHORT).show();
							}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mFRAbsLoop.start();
		setScreenBright(DetecterActivity.this,true);
